...
const OrderList = () => {
    ...
    useEffect(() => {
        axios.get(`https://pacific-chamber-36634.herokuapp.com/orders?email=${email}`)
            .then(res => {
                setOrders(res.data);
                setLoading(false);
            })
    ...
    const handleStatusChange = (id, status) => {
        ...
        axios.patch('https://pacific-chamber-36634.herokuapp.com/updateOrderStatus', modifiedStatus)
